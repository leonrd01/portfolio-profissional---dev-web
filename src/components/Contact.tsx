...
export default function Contact() {
  return (
    <section id="contact" className="py-24 px-6 md:px-12 lg:px-24 bg-bg-card/30 relative overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row gap-16 items-start lg:items-center">
          ...
          >
            <div className="mb-12">
              <span className="text-brand font-bold uppercase tracking-widest text-sm mb-4 block">Contato</span>
            ...
            <div className="space-y-10">
              <div className="flex items-center gap-6 group">
                ...
                <div>
                  ...
                  <a href="mailto:dev.leonrd@outlook.com" className="text-white font-medium text-xl hover:text-brand transition-colors">dev.leonrd@outlook.com</a>
                </div>
              </div>
              ...
              <div className="flex items-center gap-6 group">
                ...
                <div>
                  <span className="text-white/40 text-sm uppercase font-bold tracking-widest block mb-1">WhatsApp</span>
                  <a href="https://wa.me/5571985263512" className="text-white font-medium text-xl hover:text-brand transition-colors">+55 (71) 98526-3512</a>
                </div>
              </div>

              <div className="pt-8 flex items-center gap-6">
                <a href="#" className="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center text-white/40 hover:bg-brand hover:text-white transition-all duration-300">
                  <Linkedin size={24} />
                </a>
                <a href="#" className="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center text-white/40 hover:bg-brand hover:text-white transition-all duration-300">
                  <Github size={24} />
